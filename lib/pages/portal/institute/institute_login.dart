...
class InstituteLogin extends StatefulWidget {
  const InstituteLogin({super.key});
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      bulletPoint(
                                          'Confidentiality of Password is solely responsibility of the institute and all care must be taken to protect the password.'),
                                      bulletPoint(
                                      ...
                                      bulletPoint(
                                          'Institute who experience sign-in issues can contact the support team for help with account recovery.'),
                                      bulletPoint(
